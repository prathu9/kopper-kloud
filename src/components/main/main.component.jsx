...
const roadmapData1 = [
  ...
  },
  {
    ...
    title: "Q2 2022",
    list: [
      "Kindred Kompound Virtual SMART City NFT Sale",
  ...
  return (
    <main className="main-container">
      <h1 className="main-title">
        KOPPER Kloud Virtual World Represents Tangible Assets & Real Property in
        the Real World!
      </h1>
      ...
      <div ref={aboutRef} className="video-container">
        <iframe
          width="100%"
          height="100%"
          src="https://www.youtube.com/embed/-CO3DEfXPYU?si=RoHCMJbFBUBHWi6J"
      ...
      <div className="company-description">
        <p>
          Kopper Kommunities was formed to design and develop 100%
          self-sustainable, energy-efficient, transformative, and innovative
          communities. Kopper Kommunities develops blockchain networked-backed
          communities which deliver unmatched service and rewards to the
          company’s corporate tenants and residents. The firm’s self-generating
          energy capabilities enable communities essentially to become energy
          hubs by connecting our microgrids to the city’s grid.
        </p>
        <p>
          Kopper Kommunities plants the seeds of tomorrow by incorporating
          innovative and disruptive technologies in the traditional commercial
          real estate industry. The company’s vision is to develop multiple
          electricity grid-free and eco-friendly micro cities established to
          serve the community and employ the local workforce
        </p>
        <p>
          Kopper Kommunities' credo is to serve the community, employ the local
          workforce and introduce this new way of living which is ultimately
          helping our communities adapt and prepare for the up-and-coming
          cashless society.
        </p>
      </div>
      ...
      <h1 className="main-title">So what is KOPPER KLOUD Virtual World?</h1>
      <svg width="80" height="8" style={{ marginTop: "8px" }}>
        <rect width="80" height="8" fill="#E8A473" />
      </svg>
      <div className="company-description">
        <p>
          Simply put, it is a mirror of our physical KOPPER Kommunities SMART
          Micro-Cities. Our first Virtual City replicated in the MetaVerse is
          ‘Kindred Kompound Virtual City!’
        </p>
        <p>
          Kindred Kompound VC owns 3% of Kindred Kompound SMART Micro-City,
          Houston, TX. Why is this special? Well our MicroCities are self
          sustainable and self revenue generating from Mining to Self Producing
          Energy, Private Blockchain backed 5G WISP, and of course rentals and
          leases.
        </p>
        <p>
          As we tokenize all of our owned assets including land, properties,
          Mining Ops, 5G, Energy Distribution and payments of course, this type
          of operation will naturally generate a lot of daily/weekly/monthly
          revenue.
        </p>
        <p>
          So in addition to the Virtual City owning 3% of all revenue generated
          in the real world from its twin property, it also has many of its own
          revenue streams as only the MetaVerse can offer!
        </p>
        <p>Continue down this page and you will see exactly what I mean!</p>
        <p>Welcome to KOPPER KLOUD! Welcome home!</p>
      </div>
      ...
      <div ref={investorBenefitsRef} className="benefits-section">
        <div className="benefits-container">
          ...
          <div className="benefits-list-container blue-box">
            <ul>
              <li>
                Will have all pertinent project information available to
                investors
              </li>
              <li>
                User can view construction updates & see progress in 3D of their
                owned cities
              </li>
              <li>Directly purchase additional NFT's</li>
              <li>
                Directly apply for KOPPER Whales Wealth & Lifestyle Social Klub
                <br />
                <br /> after meeting the needed requirements
              </li>
            </ul>
            <h3>Future Benefits</h3>
            <ul>
              <li>
                Reserve Stays, Rent Office Space and check property revenue in
                real time (Once property is fully developed (1.5 - 2 year
                timeframe)
              </li>
              <li>
                Private Blockchain Built Specifically for Moving value in and
                Out of Our Physical & Virtual Communities
              </li>
              <li>
                Immersive Mobile AR and VR Community Engagement & Landlord
                Experience
              </li>
      ...
      <div className="ownership-section">
        <div className="ownership-container">
          ...
          <div className="ownership-wrapper blue-box">
            ...
            <div className="nft-for-sale">
              Private Round NFT’s for Sale: <span>2000</span>
            </div>
            <div className="cost-of-nft">
              Cost per NFT: <span>$250</span>
            </div>
            <div className="total-goal">
              Total Raise Goal: <span>$500K</span>
            </div>
            <div>
              <h3>Kindred Kompound NFT Reward Model:</h3>
              <span>
                Each NFT this private round qualifies for 0.0045% Virtual Land
                Ownership
              </span>
              <ul>
                <li>
                  All 2000 NFT's equal 9% total land tile ownership (Virtual
                  Landlord)
                </li>
                <li>
                  We plan to sell 100% of the Kindred Kompound Virtual City land
                  tiles by way of future NFT Sales
                </li>
                <li>
                  A holder of any 11 Kindred Kompound NFT's qualifies to apply
                  for KOPPER Whales Private Social Wealth & Lifestyle KLUB at a
                  rate that will never be offered again (Membership site coming
                  soon)
                </li>
              </ul>
              <p>
                Post Virtual World App Development: Users will be able to unlock
                land tiles after approval that your wallet Minted an NFT by
                Connecting your Whitelisted Wallet to KOPPER Kloud Virtual World
                App
              </p>
              <p>
                *All Potential Landlords and KOPPER Whales Members will be
                required to pass our KYC Process
                <br />
                *Kindred Kompound NFT's will not have to be in your possession
                to claim future land ownership
                <br />
                ...
                *Must be a holder of at least 1 Kindred Kompound NFT to qualify
                to become a Virtual Landlord *To become a KOPPER Whale member
                you will have to have in your possession (Wallet) all 11 NFT's
                it takes to qualify
                <br />
                *KOPPER Whales membership intake will be suspended after the
                first 100 members are approved
                <br />
                *Future admittance into the KLUB will have very strict
                requirements and will be by invite only
                <br />
              </p>
              <p>
                Become a holder of any 11 authentic “Kindred Kompound” NFT’s you
                qualify to apply for membership into our private Wealth &
                Lifestyle Social KLUB, “KOPPER Whales” (Membership Platform
                Coming Soon)
              </p>
              <p>
                *Qualifying investors looking to become future virtual owners
                and KOPPER Whales members will be required to pass our KYC
                process.
              </p>
            </div>
          </div>
      ...
      <div ref={partnersRef} className="business-partner-section">
        <div className="business-partner-container">
          ...
          <img
            className="business-partner-bg"
            src={businessPartnerBG}
            alt="business partner bg"
          />
